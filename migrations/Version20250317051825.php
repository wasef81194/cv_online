 ...
 */
final class Version20250317051825 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045F26F859E2 FOREIGN KEY (diplome_id) REFERENCES diplome (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
